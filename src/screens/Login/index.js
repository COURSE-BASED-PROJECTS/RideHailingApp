        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <ScrollView>
                    ...
                    <FormElement title={'Nhập mật khẩu'} placeholder={'Nhập mật khẩu'} secureTextEntry={true} />
                </ScrollView>
            </KeyboardAvoidingView>

            <View style={styles.button}>
                <Button textInside={'Đăng nhập'} style={{ width: 200, height: 50 }} handleClick={handleSubmit} />
            </View>
        </SafeAreaView>
    );
}
